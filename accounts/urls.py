...
urlpatterns = [
    ...
    path("chats/<int:chat_id>/derax/toggle/", views.derax_toggle, name="derax_toggle"),
    path("chats/<int:chat_id>/derax/run/", views.derax_run, name="derax_run"),
    path("chats/<int:chat_id>/derax/compile/", views.derax_compile, name="derax_compile"),
