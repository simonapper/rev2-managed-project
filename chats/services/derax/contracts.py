...
PHASE_MANIFEST = {
    ...
    "EXECUTE": {
        ...
        "forbidden_prefixes": [],
        "guidance": [
            "Two-step behaviour: (1) sufficiency check, then (2) artefact generation.",
            ...
            "Perform sufficiency check before generating artefacts.",
            "In intake, propose the delivery document list first, then list required inputs per document in artefacts.requirements.",
            "For each proposed document, include a seed in notes: Why, Strawman, and Suggested topics.",
            "If required inputs missing, populate artefacts.requirements and do NOT populate artefacts.generated.",
